...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <img src="img/gm-logo.png" style="width: 60px;height: 60px;" alt="MKCE">
  <h2 style="color: #eeebdd;">M KUMARASAMY COLLEGE OF ENGINEERING</h3>
  ...
  <div class="navbar-collapse collapse justify-content-end" id="navbarSupportedContent">
    ...
    <ul class="nav navbar-nav ">
      ...
      <li class="nav-item"><a class="nav-link" href="payment.php?page=payment"><i class="fa fa-dollar-sign"></i> </a></li>
